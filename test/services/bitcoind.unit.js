...
describe('Bitcoin Service', function() {
  ...
  describe('#unsubscribeAddressAll', function() {
    ...
    it('will unsubscribe emitter for all addresses', function() {
      ...
      bitcoind.subscriptions.address['DCxetay3ywv8XdYAXS4wsekLfBdMTx7Q3U'] = [emitter1];
      bitcoind.unsubscribeAddress(emitter1);
      bitcoind.subscriptions.address['8oUSpiq5REeEKAzS1qSXoJbZ9TRfH1L6mi'].length.should.equal(1);
      bitcoind.subscriptions.address['XnQuJpAgEDNtRwoXWLfuEs69cMgCYS8rgs'].length.should.equal(1);
      bitcoind.subscriptions.address['mgY65WSfEmsyYaYPQaXhmXMeBhwp4EcsQW'].length.should.equal(1);
      should.not.exist(bitcoind.subscriptions.address['DCxetay3ywv8XdYAXS4wsekLfBdMTx7Q3U']);
    });
  });
  ...
  describe('#_wrapRPCError', function() {
    it('will convert divid-rpc error object into JavaScript error', function() {
      var bitcoind = new BitcoinService(baseConfig);
  ...
  describe('#_getDefaultConf', function() {
    ...
    it('will get default rpc port for livenet', function() {
      ...
      bitcoind._getDefaultConf().rpcport.should.equal(51473);
    });
    it('will get default rpc port for testnet', function() {
      ...
      var bitcoind = new BitcoinService(config);
      bitcoind._getDefaultConf().rpcport.should.equal(51472);
    });
  ...
  describe('#_getNetworkConfigPath', function() {
    ...
    it('will get default rpc port for testnet', function() {
      ...
      var bitcoind = new BitcoinService(config);
      bitcoind._getNetworkConfigPath().should.equal('testnet3/divi.conf');
    });
    it('will get default rpc port for regtest', function() {
      bitcore.Networks.enableRegtest();
      var config = {
      ...
      var bitcoind = new BitcoinService(config);
      bitcoind._getNetworkConfigPath().should.equal('regtest/divi.conf');
    });
  });
  ...
  describe('#_getAddressStrings', function() {
    it('will get address strings from bitcore addresses', function() {
      var addresses = [
        bitcore.Address('D5xLhRVZ4Nj6nFfAo291gZr5rtj8GuHvcK'),
        bitcore.Address('DCxetay3ywv8XdYAXS4wsekLfBdMTx7Q3U'),
      ];
      var bitcoind = new BitcoinService(baseConfig);
      var strings = bitcoind._getAddressStrings(addresses);
      strings[0].should.equal('D5xLhRVZ4Nj6nFfAo291gZr5rtj8GuHvcK');
      strings[1].should.equal('DCxetay3ywv8XdYAXS4wsekLfBdMTx7Q3U');
    });
    it('will get address strings from strings', function() {
      var addresses = [
        'D5xLhRVZ4Nj6nFfAo291gZr5rtj8GuHvcK',
        'DCxetay3ywv8XdYAXS4wsekLfBdMTx7Q3U',
      ];
      var bitcoind = new BitcoinService(baseConfig);
      var strings = bitcoind._getAddressStrings(addresses);
      strings[0].should.equal('D5xLhRVZ4Nj6nFfAo291gZr5rtj8GuHvcK');
  ...
  describe('#govObject', function() {
    ...
    it('will call client gobject get and give result', function(done) {
      ...
      var gobject = sinon.stub().callsArgWith(2, null, {
        result: {
          "DataHex": "",
          "DataString": "[[\"proposal\",{\"end_epoch\":1483855193,\"name\":\"7ea9acff5ae83d8c9e217d30a2b4d10ef8f171f8\",\"payment_address\":\"yZ7DYkDHCHfH1dw7rKdYaKcVykZmunbqNL\",\"payment_amount\":84,\"start_epoch\":1483765282,\"type\":1,\"url\":\"https://www.diviproject.org\"}]]",
          "Hash": "4ef24027c631c43035aa4cf5c672e1298311decd9cffbd16731f454c9c0d6d00",
      ...
      bitcoind.govObjectHash('4ef24027c631c43035aa4cf5c672e1298311decd9cffbd16731f454c9c0d6d00', function(err, result) {
        ...
        should.equal(DataObject.url, 'https://www.diviproject.org');
        done();
      });
    });
